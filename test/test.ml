let test_hashtable () =
  ...
  QuickPrint.hashtable_int_string_list ht;;
...
let test_hashtable_int_int_list () =
  ...
  QuickPrint.hashtable_int_int_list ~prefix:"MyHashTable: " ht;;
...
let () =
  ...
  QuickPrint.chars_list ~prefix:"char_list: " [ 'h'; 'e'; 'l'; 'l'; 'o' ];
  QuickPrint.int_list ~prefix:"int_list: " [ 1; 2; 3; 4; 5 ];
  QuickPrint.float_list ~prefix:"float_list: " ~precision:2
